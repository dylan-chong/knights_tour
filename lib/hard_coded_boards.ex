defmodule HardCodedBoards do
  ...
  def for_size(width, height) do
    all["#{width}x#{height}"] || :not_found
  end

  def all do
    %{
      "6x6" => [{0, 0}, {1, 2}, {0, 4}, {2, 5}, {4, 4}, {5, 2}, {4, 0}, {3, 2}, {2, 0},
                {0, 1}, {1, 3}, {0, 5}, {2, 4}, {4, 5}, {5, 3}, {4, 1}, {3, 3}, {5, 4},
                {3, 5}, {1, 4}, {2, 2}, {0, 3}, {1, 5}, {3, 4}, {5, 5}, {4, 3}, {5, 1},
                {3, 0}, {1, 1}, {2, 3}, {4, 2}, {5, 0}, {3, 1}, {1, 0}, {0, 2}, {2, 1},
                {0, 0}],

      "6x8" => [{0, 0}, {1, 2}, {2, 0}, {0, 1}, {1, 3}, {0, 5}, {1, 7}, {3, 6}, {5, 7},
      ...
      "8x8" => [{0, 0}, {1, 2}, {2, 0}, {0, 1}, {1, 3}, {0, 5}, {1, 7}, {3, 6}, {5, 7},
      ...
      "8x10"=> [{0, 0}, {2, 1}, {0, 2}, {1, 0}, {3, 1}, {5, 0}, {7, 1}, {6, 3}, {7, 5},
      ...
      "10x10"=>[{0, 0}, {1, 2}, {0, 4}, {1, 6}, {0, 8}, {2, 9}, {4, 8}, {6, 9}, {8, 8},
      ...
      "10x12"=>[{0, 0}, {1, 2}, {0, 4}, {1, 6}, {0, 8}, {1, 10}, {3, 11}, {2, 9},
